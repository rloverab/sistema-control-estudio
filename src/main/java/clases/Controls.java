...
public final class Controls {
    ...
    /**
     * Llena un JComboBox con datos de un objeto ArrayList de String.
     *
     * @param comboBox JComboBox a llenar.
     * @param arrayList Lista de elemento a ingresar en la JComboBox.
    ...
    /**
     * Llena el JList con elementos de una ArrayList de String.
     *
     * @param list JList a llenar.
     * @param arrayList ArrayList con los elementos para agregar.
     */
    ...
    public static void moveElementJList(
        ...
        Object item;
        DefaultListModel origiModel;
        DefaultListModel destinationModel;

        origiModel = (DefaultListModel) originList.getModel();
    ...
    public static boolean isValidFields(ArrayList<Object[]> fields, boolean withMessage) {
        String message;
        String fieldName;
        Component component;
        Component parent;
